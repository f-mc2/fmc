...
The reference point can be dragged to explore the behaviour at other points in the domain.
The function is $f\colon\mathbb{R}\rightarrow\mathbb{R}$ given by $f(x) = 1/8 x^3$.
Type in "f(x) = " to try a different function. 
